...
/*m bbc_micro_with_rams
 */
extern module bbc_micro_with_rams( clock clk "4MHz clock in as a minimum",
                            clock video_clk,
                            input bit reset_n,
                            input t_csr_request csr_request,
                            output t_csr_response csr_response,
...
extern module bbc_display( clock clk "Clock running at 2MHz",
                           //input bit reset_n,
                            ...
                            input t_bbc_micro_sram_response host_sram_response,
                            input t_bbc_display_sram_write display_sram_write,
                            input t_video_bus video_bus )
{
    ...
    timing from rising clock clk host_sram_request;
    timing to   rising clock clk host_sram_response;

    timing to   rising clock clk display_sram_write;
}

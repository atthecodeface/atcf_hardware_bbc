...
// make -f Vbbc_micro_with_rams.mk 
// g++ ../../atcf_hardware_bbc/tb_v/tb_bbc_micro_with_rams.cpp ${VERILATOR_ROOT}/include/verilated.cpp Vbbc_micro_with_rams__ALL.a -I${VERILATOR_ROOT}/include -I.
